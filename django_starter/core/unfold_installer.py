# File: django_starter/core/unfold_installer.py
...
class UnfoldInstaller:
    def __init__(self, project_name, main_app_name):
        self.base_dir = Path.cwd()
        self.project_name = project_name
        self.main_app_name = main_app_name
        self.settings_path = self.base_dir / project_name / "settings.py"
        self.admin_path = self.base_dir / main_app_name / "admin.py"
